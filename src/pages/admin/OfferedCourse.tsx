...
import { useGetAcademicFacultiesQuery, useGetAllAcademicDepartmentsQuery } from '../../redux/features/admin/academicManagement.api';
...
const OfferedCouseForAll = () => {
  ...
  const { data: facultiesData, isFetching: fetchingFaculties } =
    ...
    //skip use korchi karon -> courseId fetch na hoa porjonto ei query call hobe na
...
export default OfferedCouseForAll;