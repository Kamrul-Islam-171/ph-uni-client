...
const courseManagementApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getAllRegisteredSemesters: builder.query({
      ...
      providesTags: ['semester'], // for invalid cacahe behavouir
    ...
    addRegisteredSemester: builder.mutation({
      ...
      invalidatesTags: ['semester'] // cache behavour invalid korar jonno
    }),
    updateCourseStatus: builder.mutation({
      ...
      invalidatesTags: ['semester'] // update korle jano refresh deoa na lage.
    }),
